          ...
          <div className="card-body p-4">
            ...
            <div className="row mb-4">
              <div className="col-md-6">
                <div className="info-card mb-3 p-3" style={{ border: '1px solid #e0e0e0', borderRadius: '0.5rem', backgroundColor: '#f8f9fa' }}>
                  <div className="d-flex align-items-center">
                    <FaCalendarAlt className="me-3" style={{ color: '#005f73', fontSize: '1.5rem' }} />
                    <div>
                ...
                <div className="info-card mb-3 p-3" style={{ border: '1px solid #e0e0e0', borderRadius: '0.5rem', backgroundColor: '#f8f9fa' }}>
                  <div className="d-flex align-items-center">
                    <FaClock className="me-3" style={{ color: '#005f73', fontSize: '1.5rem' }} />
                    <div>
              ...
              <div className="col-md-6">
                ...
                <div className="info-card mb-3 p-3" style={{ border: '1px solid #e0e0e0', borderRadius: '0.5rem', backgroundColor: '#f8f9fa' }}>
                  <div className="d-flex align-items-center">
                    <FaRupeeSign className="me-3" style={{ color: '#005f73', fontSize: '1.5rem' }} />
                    <div>
